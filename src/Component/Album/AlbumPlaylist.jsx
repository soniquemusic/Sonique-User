...
const AlbumPlaylist = ({ album, onClose, isLoading }) => {
  ...
  const setupAudio = useCallback(() => {
    ...
    audioRef.current = new Audio(album.songs[currentTrackIndex].audio_url);
  ...
  }, [album, currentTrackIndex, isLoading]);
  ...
  const handleTrackSelect = useCallback((index) => {
    ...
    if (audioRef.current) {
      audioRef.current.pause();
      audioRef.current.src = album.songs[index].audio_url;
            ...
            >
              ...
              <div className="col-span-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">{currentSong.sAuthor}</p>
                </div>
              </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
          ...
          <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-1/4 order-1 sm:order-none">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-400 truncate">{currentSong.artist || album.artist}</p>
            </div>
            <button 
